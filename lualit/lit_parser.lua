local lit = {}
local stringtools = require("lualit.stringtools")

-- Replace fences with newlines and pad everything inside
local function replace_fenced_blocks(match)
  return "\n\n" .. stringtools.pad(match, "    ") .. "\n"
end
